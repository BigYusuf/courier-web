    ...
    <div>
        <section className="section delivery section--space-top">
            ...
            Services to all of our Customers.
                            ...
                            <img src="images/arrow.png" alt="Image" className="d-none d-lg-block"/>
                        </div>
                    </div>
                    <div className="col-12 col-lg-4 section__col text-start text-lg-end">
                        <div className="video-wrap">
                            <a href="https://www.youtube.com" target="_blank" title="video Player" className="video-btn">
                            ...
                            <div className="row section section--space-top">
                                <div className="col-12 col-lg-4">
                                    <div className="delivery__thumb d-none d-lg-block">
                                        <img src="images/delivery-man.png" alt="Image" data-speed="auto"/>
                                    </div>
                                </div>
                                        ...
                                        <div className="delivery__content-form">
                                            <form action="#" method="post">
                                                ...
                                                <div className="group-input">
                                                    ...
                                                    <div className="single-input">
                                                        <input type="number" name="contact-phone" id="contactPhone" placeholder="Phone No" required=""/>
                                                    </div>
                                                </div>
