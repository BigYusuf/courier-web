                        ...
                        <nav className="nav">
                            <div className="nav__content">
                                ...
                                <div className="nav__menu">
                                    <button aria-label="close navbar" className="nav__menu-close d-block d-xl-none">
                                        <i className="fa-solid fa-xmark"></i>
                                    </button>
                                    <div className="nav__menu-logo d-flex d-xl-none">
                                        <a href="/" className="text-center hide-nav">
                                            <img src="images/logo-dark.png" alt="Logo" className="w-44 h-auto" />
                                        </a>
                                    </div>
                                    <ul className="nav__menu-items">
                                        ...
                                        <li className="nav__menu-item">
                                            <a className="nav__menu-link hide-nav" href="/contact">
                                                Contact
                                            </a>
                                        </li>
                                ...
                                <div className="nav__uncollapsed">
                                    ...
                                    <button className="nav__bar d-block d-xl-none" aria-label="toggle navbar">
